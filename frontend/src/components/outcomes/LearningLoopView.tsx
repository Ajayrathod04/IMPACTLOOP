  ...
  const historicalOutcomes = [
    {
      ...
      accuracy: "96.4%",
      lesson:
        "ImpactLoop uses observed outcomes to validate or challenge assumptions used in future evaluations.",
    },
    {
      id: "OUT-2026-002",
      ...
      accuracy: "94.1%",
      lesson:
        "Redis token caching layer eliminated 40% of anticipated database lookup queries.",
    },
    {
      id: "OUT-2026-003",
      ...
      learned:
        "HTTP Sunset headers prevented 11 anticipated partner integration failures.",
      accuracy: "91.8%",
      lesson:
        "Publishing HTTP Sunset headers 30 days prior accelerated 75% of partner migration.",
    },
  ];
    ...
    <div className="space-y-6 select-none">
      ...
      <div className="bg-[#0b0e17] border border-slate-800/90 rounded-xl p-5 space-y-4 shadow-xl">
        ...
        <p className="text-xs text-slate-300 leading-relaxed font-sans max-w-3xl">
          ImpactLoop uses observed outcomes to validate or challenge assumptions
          used in future evaluations.{" "}
          <strong className="text-amber-400 font-mono">
            Every completed change recalibrates decision weights automatically.
          </strong>
        </p>
      </div>
      ...
      <div className="space-y-5">
        ...
        {historicalOutcomes.map((item) => (
          <div
            key={item.id}
            className="bg-[#0b0e17] border border-slate-800/90 rounded-xl p-5 space-y-4 shadow-xl"
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-800/80 pb-3">
              <div>
                ...
                <h4 className="text-base font-bold text-ivory-100 font-sans tracking-tight">
                  {item.title}
                </h4>
              </div>
